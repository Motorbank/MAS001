...
public:
	...
	//void set_NorminalSpeed(); 			// 9. 모터 정격속도 설정 (송신)
	//void set_Resolution(); 				// 10. 분해능 설정 (송신)
	//void set_ReductionRatio(); 			// 11. 감속비 설정 (송신)
	//void set_ControllerOn(); 			// 12. 제어 On/Off 설정 (송신)
	//void set_PositionMode(); 			// 13. 위치제어 모드 설정 (송신)
	//void set_PositionDirection(); 		// 14. 제어 방향 설정 (송신)
	//void set_PositionInit(); 			// 15. 위치 초기화 (송신)
